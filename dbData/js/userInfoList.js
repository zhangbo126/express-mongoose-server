db.getCollection("userInfoList").insert( {
    ...
    phone: "15958665541",
    status: NumberInt("1"),
    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoi5r24IiwiaWQiOiI5NXdtb2JjbXF1dzAwMDAwIiwiaWF0IjoxNjM4MDE5NTQ1LCJleHAiOjE2MzgzNzk1NDV9.sKdSw0ytuunV6mdxq3pFdQ3P1RuGxNXzYl5ThGrpN10",
    userAccount: "admin",
    userRole: [
